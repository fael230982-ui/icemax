...
export const icemaxApi = {
  ...
  mobileOfflineAssistedRetryProductionReadiness: (token?: string) =>
  ...
  mobileOfflineAssistedRetryProviderActivationGate: (token?: string) =>
    apiRequest<unknown>("/platform/mobile-offline-escalations/provider-activation-gate", { token }),
  mobileOfflineAssistedRetryProviderHomologationRunbook: (token?: string) =>
  ...
  mobileOfflineAssistedRetryWhitelabelOnboardingChecklist: (token?: string) =>
  ...
  mobileOfflineAssistedRetryWhitelabelPostGoLivePlan: (token?: string) =>
    apiRequest<unknown>("/platform/mobile-offline-escalations/whitelabel-post-go-live-plan", { token }),
  mobileOfflineAssistedRetryWhitelabelTenantHealthScore: (token?: string) =>
    apiRequest<unknown>("/platform/mobile-offline-escalations/whitelabel-tenant-health-score", { token }),
  mobileOfflineAssistedRetryWhitelabelContinuousImprovement: (token?: string) =>
    apiRequest<unknown>("/platform/mobile-offline-escalations/whitelabel-continuous-improvement", { token }),
  mobileOfflineAssistedRetryWhitelabelScaleDecision: (token?: string) =>
    apiRequest<unknown>("/platform/mobile-offline-escalations/whitelabel-scale-decision", { token }),
  mobileOfflineAssistedRetryWhitelabelSecondTenantPreOnboarding: (token?: string) =>
  ...
  mobileOfflineAssistedRetryWhitelabelPartnerGoLiveAcceptance: (token?: string) =>
